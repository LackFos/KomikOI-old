    ...
    <div class="swiper-wrapper">
        ...
        @foreach ($comics as $c)
            <div class="swiper-slide">
                <div class="slider-bgimage" style="background-image: url({{ asset($c->comic->image) }})"></div>

                <div class="slider-poster">
                    <div class="slider-poster-placeholder">
                        <img src="{{ asset($c->comic->image) }}" alt="Komik {{ $c->comic->title }}">
                    </div>
                </div>
                ...
                <div class="slider-detail">
                    ...
                    <div class="slider-button">
                        <a @class([
                            ...
                            href="{{ $c->comic->firstChapter ? '/baca/' . $c->comic->firstChapter->slug : '#' }}">
                            Baca Sekarang
                        </a>
                        <a href="/detail/{{ $c->comic->slug }}" class="button secondary">Detail</a>
                    </div>
                </div>
            </div>
        @endforeach
